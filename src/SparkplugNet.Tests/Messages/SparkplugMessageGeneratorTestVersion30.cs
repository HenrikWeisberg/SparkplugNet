...
public sealed class SparkplugMessageGeneratorTestVersion30
{
    ...
    public void TestDeviceDeathMessageNamespaceB()
    {
        ...
        var payloadVersionB = PayloadHelper.Deserialize<VersionB.ProtoBuf.ProtoBufPayload>(message.Payload);
    ...
    public void TestNodeDeathMessageNamespaceB()
    {
        ...
        var payloadVersionB = PayloadHelper.Deserialize<VersionBProtoBuf.ProtoBufPayload>(message.Payload);
